...
class Item:
    ...
    kind: str | None = None  # finer grouping than category: boots, crewneck, ...
...
CLOSET: list[Item] = [
    ...
    _i("own_104", "Charcoal hoodie", "top", 64, 1, 3, False, "charcoal", "fleece", "M", 0.80),
    ...
    _i("own_120", "Straight-leg jeans", "bottom", 88, 2, 2, False, "indigo", "denim", "27", 0.90),
    _i("own_121", "Black jeans", "bottom", 78, 3, 2, False, "black", "denim", "27", 0.85),
    _i("own_122", "Sweatpants", "bottom", 45, 1, 3, False, "grey", "cotton", "S", 0.80),
    _i("own_123", "Leggings", "bottom", 32, 1, 2, False, "black", "nylon", "S", 0.85),
    _i("own_124", "Denim mini skirt", "bottom", 42, 3, 1, False, "indigo", "denim", "27", 0.50),
    # --- outerwear ------------------------------------------------------------
    _i("own_130", "Puffer jacket", "outer", 140, 2, 5, False, "black", "nylon", "S", 0.85),
    _i("own_131", "Denim jacket", "outer", 95, 2, 2, False, "indigo", "denim", "S", 0.70),
    _i("own_132", "Rain shell", "outer", 110, 2, 3, True, "olive", "nylon", "S", 0.75),
    # --- athletic -------------------------------------------------------------
    _i("own_140", "Running shorts", "bottom", 28, 1, 1, False, "black", "poly", "S", 0.80),
    _i("own_141", "Sports bra", "top", 34, 1, 1, False, "black", "nylon", "S", 0.85),
    _i("own_142", "Training tee", "top", 26, 1, 2, False, "white", "poly", "S", 0.75),
    # --- shoes ----------------------------------------------------------------
    _i("own_150", "White sneakers", "shoes", 85, 2, 2, False, "white", "leather", "8", 0.90),
    ...
    _i("own_153", "Strappy heels", "shoes", 78, 4, 1, False, "black", "leather", "8", 0.45),
    # --- one nice dress, but it is not warm ----------------------------------
    _i("own_160", "Black slip dress", "dress", 95, 4, 2, False, "black", "silk", "S", 0.78),
]
...
STOREFRONT: list[Item] = [
    ...
    _i("sku_993", "Wool blazer", "outer", 165, 5, 4, False, "navy", "wool", "S"),
    _i("sku_994", "Slip dress", "dress", 89, 4, 1, False, "emerald", "satin", "S", 0.7, "going_out_dress"),
    _i("sku_995", "Cashmere scarf", "accessory", 74, 3, 4, False, "camel", "cashmere", None),
    _i("sku_996", "Platform sneakers", "shoes", 95, 2, 2, False, "white", "leather", "8"),
    _i("sku_997", "Quilted rain parka", "outer", 148, 2, 4, True, "black", "nylon", "S", 0.7, "rain_outer"),
    _i("sku_998", "Ribbed tank", "top", 24, 2, 1, False, "white", "cotton", "S"),
